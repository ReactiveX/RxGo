...
func Test_Single_Filter_True(t *testing.T) {
	...
	AssertOptionalSingle(context.Background(), t, os, HasItem(1), HasNotRaisedError())
}
...
func Test_Single_Filter_False(t *testing.T) {
	...
	AssertOptionalSingle(context.Background(), t, os, HasNoItem(), HasNotRaisedError())
}
...
func Test_Single_Map(t *testing.T) {
	...
	AssertSingle(context.Background(), t, single, HasItem(2), HasNotRaisedError())
}
