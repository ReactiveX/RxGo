...
// 	default:
// 		Errors(IllegalInputError{error: fmt.Sprintf("expected type: float or int, got: %t", item)}).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 	case int:
// 		op.sum += float32(v)
// 		op.count++
...
// 	switch v := item.V.(type) {
// 	default:
// 		Errors(IllegalInputError{error: fmt.Sprintf("expected type: int, got: %t", item)}).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 	case int:
// 		op.sum += v
// 		op.count++
...
// 	switch v := item.V.(type) {
// 	default:
// 		Errors(IllegalInputError{error: fmt.Sprintf("expected type: int8, got: %t", item)}).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 	case int8:
// 		op.sum += v
// 		op.count++
...
// 	switch v := item.V.(type) {
// 	default:
// 		Errors(IllegalInputError{error: fmt.Sprintf("expected type: int16, got: %t", item)}).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 	case int16:
// 		op.sum += v
// 		op.count++
...
// 	switch v := item.V.(type) {
// 	default:
// 		Errors(IllegalInputError{error: fmt.Sprintf("expected type: int32, got: %t", item)}).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 	case int32:
// 		op.sum += v
// 		op.count++
...
// 	switch v := item.V.(type) {
// 	default:
// 		Errors(IllegalInputError{error: fmt.Sprintf("expected type: int64, got: %t", item)}).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 	case int64:
// 		op.sum += v
// 		op.count++
...
// 			Errors(err).SendContext(ctx, next)
// 			close(next)
// 			return
// 		}
// 		close(next)
...
// 	if err != nil {
// 		Errors(err).SendContext(ctx, dst)
// 		operatorOptions.stop()
// 		return
// 	}
// 	_, ok := op.keyset[key]
...
// 	if !op.sent {
// 		Errors(&IllegalInputError{}).SendContext(ctx, dst)
// 	}
// }
...
// 				if idx >= length {
// 					err := Errors(IndexOutOfBoundError{error: fmt.Sprintf("index %d, length %d", idx, length)})
// 					for i := 0; i < length; i++ {
